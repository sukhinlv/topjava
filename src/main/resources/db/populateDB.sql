...
VALUES ('2020-01-30 10:00', 'Завтрак', 500, 100000),
    ...
    ('2020-01-30 10:00', 'Breakfast', 500, 100001),
    ('2020-01-30 13:00', 'Lunch', 1000, 100001),
    ('2020-01-30 20:00', 'Dinner', 500, 100001),
    ('2020-01-31 00:00', 'Meal on border time', 100, 100001),
    ('2020-01-31 10:00', 'Breakfast', 1000, 100001),
    ('2020-01-31 13:00', 'Lunch', 500, 100001),
    ('2020-01-31 20:00', 'Dinner', 410, 100001);
